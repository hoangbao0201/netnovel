...
import styles from "./ContentFormNewNovel.module.scss";

const cx = classNames.bind(styles);

export interface ContentFormNewNovelProps {}
                ...
                <div className={cx("form")}>
                    ...
                    <div className={cx("form-group")}>
                        ...
                        <QuillNoSSRWrapper
                            ...
                            className="customize-quill-new-novel"
...
export default ContentFormNewNovel;
